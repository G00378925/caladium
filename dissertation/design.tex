...
The DOM is a tree of nested elements that represents a web pages HTML.
...
To get/set attributes of the record use the instances methods of \texttt{DatabaseRecord}.
...
The second button is "Chat with CaladiumBot",
